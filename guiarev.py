...
def mostrar_nota_inicial():
    ...
    messagebox.showinfo("Instrucciones", "Bienvenido a la aplicación de revisión, se realizaran 100 preguntas referentes al protocolo asignado, en esta versión no es posible regresar a las preguntas una vez contestadas u omitidas")
